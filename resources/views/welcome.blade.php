                ...
                <div class="table-responsive">
                    <table class="table custom-table text-dark">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <img src="{{asset("/assets/images/faces/face5.jpg")}}" class="mr-2" alt="image" />
                                    Ina Curry </td>
                                <td>
                                    <div class="d-flex">
                            ...
                            <tr>
                                <td>
                                    <img src="{{asset("/assets/images/faces/face7.jpg")}}" class="mr-2" alt="image" />
                                    Lida Fitzgerald </td>
                                <td>
                                    <div class="d-flex">
                            ...
                            <tr>
                                <td>
                                    <img src="{{asset("/assets/images/faces/face9.jpg")}}" class="mr-2" alt="image" />
                                    Maria Ortiz </td>
                                <td>
                                    <div class="d-flex">
                                        <span class="pr-2 d-flex align-items-center">65%</span>
...
<div class="row">
    ...
    <div class="col-sm-6 col-xl-4 stretch-card grid-margin">
        <div class="card color-card-wrapper">
            <div class="card-body">
                <img class="img-fluid card-top-img w-100" src="{{asset("/assets/images/dashboard/img_5.jpg")}}"
                    alt="" />
