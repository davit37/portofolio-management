        ...
        function m(a, c, p) {
            ...
            function E(e, t, n, a) {
                ...
                var r, o, s, l = [],
                    ...
                    c = O();
                do {
                    if (!0 === e && M().validPositions[u]) o = (s = M().validPositions[u]).match, r = s.locator.slice(), l.push(!0 === n ? s.input : !1 === n ? o.nativeDef : $(u, o));
                    else {
                    ...
                    function l(o, s, u) {
                        ...
                        if (o.matches !== i) {
                            if (o.isGroup && u !== o) {
                                ...
                                for (var H = o, V = a.length > 0 ? a.shift() : 0; V < (isNaN(H.quantifier.max) ? V + 1 : H.quantifier.max) && c <= t; V++) {
            ...
            function H(t, n, a, r, o) {
                var s, l, u, c, f, m, d, h = e.extend(!0, {}, M().validPositions),
                    g = !1,
                    v = o !== i ? o : O();
                if (-1 === v && o === i) l = (c = T(s = 0)).alternation;
                else
                    for (; v >= 0; v--)
                        if ((u = M().validPositions[v]) && u.alternation !== i) {
            ...
            function V(t, n, a, r, o, s) {
                ...
                if (e.isFunction(p.preValidation) && !a && !0 !== r && !0 !== s && (m = p.preValidation(I(), c, n, l(t), p, M())), !0 === m) {
                    ...
                    }!1 !== m || null === p.keepStatic || !1 === p.keepStatic || a || !0 === o || (m = H(c, n, a, r)), !0 === m && (m = {
                        pos: c
                    })
                }
                ...
                Y = {
                    keydownEvent: function (t) {
                        var n = this,
                            ...
                            a = t.keyCode,
                            r = ne(n);
                        if (a === u.keyCode.BACKSPACE || a === u.keyCode.DELETE || l && a === u.keyCode.BACKSPACE_SAFARI || t.ctrlKey && a === u.keyCode.X && !f("cut")) t.preventDefault(), oe(n, a, r), W(n, I(!0), M().p, t, n.inputmask._valueGet() !== I().join("")), n.inputmask._valueGet() === G().join("") ? i.trigger("cleared") : !0 === re(I()) && i.trigger("complete");
                    ...
                    pasteEvent: function (n) {
                        ...
                        if (u === (b ? G().reverse() : G()).slice(0, l.begin).join("") && (u = ""), c === (b ? G().reverse() : G()).slice(l.end).join("") && (c = ""), b && (i = u, u = c, c = i), t.clipboardData && t.clipboardData.getData) s = u + t.clipboardData.getData("Text") + c;
                        else {
            ...
            function ae(e) {
                ...
                for (;
                    (t = M().validPositions[n - 1]) && t && t.match.optionality && t.input === p.skipOptionalPartCharacter;) n--;
                return e.splice(n), e
            }
            ...
            function oe(e, t, n, a, r) {
                ...
                var l = O(n.begin, !0);
                if (l < n.begin || -1 === n.begin) M().p = Q(l);
                else if (!0 !== a && (M().p = n.begin, !0 !== r))
                    for (; M().p < l && M().validPositions[M().p] === i;) M().p++
            }
    ...
    o = function (e, t) {
        ...
        function r(e, i, r) {
            for (var o, s = ""; o = a(r).exec(e);) {
                if (void 0 === i) s += n[o[0]] ? "(" + n[o[0]][0] + ")" : t.escapeRegex(o[0]);
        ...
        return t.extendAliases({
            numeric: {
                ...
                definitions: {
                    "~": {
                        validator: function (e, i, a, r, o, s) {
                            ...
                            if (!0 === (l = r ? new RegExp("[0-9\uFF10-\uFF19" + t.escapeRegex(o.groupSeparator) + "]").test(e) : new RegExp("[0-9\uFF10-\uFF19]").test(e))) {
                ...
                isComplete: function (e, n) {
                    ...
                    return a = (a = (a = (a = a.replace(new RegExp(t.escapeRegex(n.negationSymbol.back) + "$"), "")).replace(n.prefix, "")).replace(n.suffix, "")).replace(new RegExp(t.escapeRegex(n.groupSeparator) + "([0-9\uFF10-\uFF19]{3})", "g"), "$1"), "," === n.radixPoint && (a = a.replace(t.escapeRegex(n.radixPoint), ".")), isFinite(a)
                },
